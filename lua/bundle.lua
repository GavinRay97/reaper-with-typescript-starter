...
["example"] = function() --[[ Generated with https://github.com/TypeScriptToLua/TypeScriptToLua ]]
require("lualib_bundle");
project = reaper.GetCurrentProjectInLoadSave()
numTracks = reaper.CountTracks(project)
tracks = {}
do
    idx = 0
    while idx < numTracks do
        __TS__ArrayPush(
            tracks,
            reaper.GetTrack(project, idx)
        )
        idx = idx + 1
    end
end
for ____, track in ipairs(tracks) do
